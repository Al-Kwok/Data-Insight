...
describe("InsightFacade", function () {
	...
	describe("PerformQuery", function () {
		...
		// New query features tests
		it("[invalid/invalidTransformations.json] Invalid transformations missing GROUP", checkQuery);
		// Room dataset tests
		it("[valid/roomsBasic.json] Basic rooms query", checkQuery);
		it("[invalid/roomsInvalidField.json] Invalid room field in query", checkQuery);
	});
});
// Code generated by Claude Sonnet 4 and adjusted as needed by Elena Kolmogorov and Alex Kwok
